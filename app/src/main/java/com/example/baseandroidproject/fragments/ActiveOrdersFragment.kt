...
import com.example.baseandroidproject.databinding.FragmentActiveOrdersBinding
...
class ActiveOrdersFragment : Fragment() {
    ...
    private fun filterByOrdreStatus() {
        val filteredByActive = Storage.listOfOrders.filter { it.status == OrderStatus.Active }
