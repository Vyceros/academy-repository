...
interface AuthorizationService {
    ...
    @POST("login")
    suspend fun loginUser(@Body loginRequest: AuthRequestDto): Response<AuthResponseDto>

    @POST("register")
    suspend fun registerUser(@Body registerRequest: AuthRequestDto): Response<AuthResponseDto>
}